...
`;
  ...
  const analysisSteps = [
    ...
    { step: 2, title: "Business Functions & KPIs", desc: "Analyzing 12 departments and KPIs..." },
    { step: 3, title: "Friction Points", desc: "Identifying 12 operational bottlenecks..." },
    { step: 4, title: "AI Use Cases", desc: "Generating 12 use cases with 1:1:1 mapping..." },
